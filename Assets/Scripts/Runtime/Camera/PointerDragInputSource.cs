...
{
    public abstract class PointerDragInputSource<TFrame> : MonoBehaviour
    {
        ...
        protected abstract TFrame NoneFrame { get; }
        protected abstract TFrame CreateFrame(Vector2 delta);
        ...
        private TFrame ReadPointerFrame(Vector2 position, bool pressed, PointerKind pointerKind)
        {
            if (!pressed)
            {
                CancelGesture();
